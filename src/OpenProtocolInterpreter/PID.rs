...
pub enum TighteningProgramInformationPID
{
    /// <summary>
...
pub enum TorqueControllerInformationPID
{
    /// <summary>
...
pub enum ErrorAndStatusCodesPID
{
    /// <summary>
...
pub enum TighteningValuesForTracePID
{
    /// <summary>
...
pub enum GeneralDownloadDataStatusForRadioConnectedToolsPID
{
