...
impl Mid0002T {
    ...
    /// <para>Cell ID for PF4000</para>
    /// </summary>
    pub fn station_cell_name(self) ->String {
        self.mid.get_field(6, DataFields::StationCellName as i32).value
    }

    pub fn set_station_cell_name(self, value:String) {
    ...
    pub fn set_client_id(self, value:String) {
